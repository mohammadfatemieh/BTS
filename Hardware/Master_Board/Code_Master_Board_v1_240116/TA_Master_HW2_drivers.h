...
#define SCK_H         GPIO_SetBits(GPIOB , GPIO_Pin_15) //GPIOB->BSRR = GPIO_Pin_x       
#define SCK_L         GPIO_ResetBits(GPIOB , GPIO_Pin_15) // GPIOB->BRR  = GPIO_Pin_x  

#define	SHT1x_SDA   	GPIO_Pin_8
#define	SHT1x_SCL   	GPIO_Pin_15
