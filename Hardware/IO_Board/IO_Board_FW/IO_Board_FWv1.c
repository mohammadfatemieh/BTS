...
//   if(data=='7') Relay7=1;
  // if(data=='8') Relay8=1;
   //if(data=='0') {Relay1=0;Relay2=0;Relay3=0;Relay4=0;Relay5=0;Relay6=0;Relay7=0;Relay8=0;}     
     if(data=='~') process_CMD=1;
     CMD[index++]=data;
     if(index==7) index=0;
   }
}
...
while (1)
      ...
      // Place your code here  
           ...
           {
                //printf("%s",CMD);
                if((CMD[0]=='G')&&(CMD[1]=='E')&&(CMD[2]=='T')&&(CMD[3]=='_')&&(CMD[4]=='B')&&(CMD[5]=='T')) printf("LG_IN:%c\r\n",GET_LG_STT);
                else if((CMD[0]=='G')&&(CMD[1]=='E')&&(CMD[2]=='T')&&(CMD[3]=='_')&&(CMD[4]=='R')&&(CMD[5]=='L')) printf("RL_OUT%c\r\n",GET_RL_STT);
                else if((CMD[0]=='O')&&(CMD[1]=='U')&&(CMD[2]=='T')&&(CMD[3]=='_')) 
                {
                    //printf("OUT:%d\r\n",CMD[4]);
                    Relay1=CMD[4]&0x80;
                    Relay2=CMD[4]&0x40;
...
//      if(LG_IN_1==1) printf("LG_IN_1\r\n");
//      if(LG_IN_2==1) printf("LG_IN_2\r\n");
//      if(LG_IN_3==1) printf("LG_IN_3\r\n");
//      if(LG_IN_4==1) printf("LG_IN_4\r\n");
//      if(PINB.0==1) printf("LG_IN_5\r\n"); 
//
//      if(LG_IN_6==1) printf("LG_IN_6\r\n");
//      if(LG_IN_7==1) printf("LG_IN_7\r\n");
//      if(LG_IN_8==1) printf("LG_IN_8\r\n"); 
