...
//{
//	// Check connection to SHT1x
//	I2C_GenerateSTART(I2C_SHT1x,ENABLE); // Send START condition
//	while (!I2C_CheckEvent(I2C_SHT1x,I2C_EVENT_MASTER_MODE_SELECT)); // Wait for EV5
//	I2C_Send7bitAddress(I2C2,SHT1x_STATUS_REG_W,I2C_Direction_Transmitter); // Send SHT1x slave address
//	while (!I2C_CheckEvent(I2C2,I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED)); // Wait for EV6
//	I2C_GenerateSTOP(I2C_SHT1x,ENABLE);
