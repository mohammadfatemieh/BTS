...
#define AM2301_PIN				7 //(AUX9)
//#endif

/* Pin settings */
#define AM2301_PIN_LOW			GPIO_PinWrite(AM2301_PORT, AM2301_PIN, 0);
#define AM2301_PIN_HIGH			GPIO_PinWrite(AM2301_PORT, AM2301_PIN, 1);
#define AM2301_PIN_IN			  GPIO_PinConfigure(AM2301_PORT, AM2301_PIN,GPIO_IN_PULL_UP,GPIO_MODE_INPUT);
#define AM2301_PIN_OUT			GPIO_PinConfigure(AM2301_PORT, AM2301_PIN,GPIO_OUT_PUSH_PULL,GPIO_MODE_OUT50MHZ);
#define AM2301_PIN_READ			GPIO_PinRead(AM2301_PORT,AM2301_PIN)
