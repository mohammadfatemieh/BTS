...
#define         KEY4X4_ROW3_UP         GPIO_PinWrite(GPIOB,11,1)//   
...
#define         KEY4X4_ROW3_DOWN         GPIO_PinWrite(GPIOB,11,0)//   
...
static void SDA_H(void)
{
  ...
  /* PB.11 ( DATA out ) */
   GPIO_InitStructure.GPIO_Pin = SHT1x_SDA;
   GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
   GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
   GPIO_Init(SHT1x_PORT, &GPIO_InitStructure);

   GPIO_SetBits(SHT1x_PORT , SHT1x_SDA);
//	 GPIO_PinConfigure(GPIOB, 11,
//                      GPIO_OUT_PUSH_PULL, 
//                      GPIO_MODE_OUT50MHZ);
...
static void SDA_L(void)
{
  ...
  /* PB.11 ( DATA out ) */
   ...
   GPIO_ResetBits(SHT1x_PORT , SHT1x_SDA);
//	 GPIO_PinConfigure(GPIOB, 11,
//                      GPIO_OUT_PUSH_PULL, 
//                      GPIO_MODE_OUT50MHZ);
...
//                      GPIO_MODE_INPUT);
   ...
   j = GPIO_ReadInputDataBit(SHT1x_PORT , SHT1x_SDA);
...
{  
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	GPIO_InitStructure.GPIO_Pin = SHT1x_SDA|SHT1x_SCL;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(SHT1x_PORT, &GPIO_InitStructure);
